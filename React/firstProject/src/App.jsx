...
import ImportedStyleSheet from "./components/ImportedStyleSheet.jsx";
import CssModule1 from "./components/CssModule1.jsx";
import CssModule2 from "./components/CssModule2.jsx";
...
function App() {
  ...
  return (
    <div className="App">
      ...
      <h1>This is to handle inputs in the forms</h1>
      <Form1 />

      <h1>This is to check for the multiple inputs in React forms</h1>
      <Form2 />

      <h1>This is the inline styling in JSX</h1>
      <InlineStyle />

      <h1>This is for the imported styling</h1>
      <ImportedStyleSheet />

      <h1>This is used to get the styling from css module</h1>
      <CssModule1 />
      <h1>This is used to get the styling from css module</h1>
      <CssModule2 />
    </div>
